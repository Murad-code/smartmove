 ...
 * Demo properties.
 *
 * Written from scratch for this project, not copied from any listing site.
 * Every one is labelled so nobody mistakes them for live stock.
 */
export const demoProperties = [
  {
    title: 'Three bedroom semi-detached house, Ashby',
    displayLocation: 'Ashby, Scunthorpe',
    status: 'available',
    monthlyRent: 725,
    deposit: 830,
    bedrooms: 3,
    ...
    featured: true,
    shortDescription:
      'A well-kept three bedroom semi with a driveway and an enclosed rear garden, close to local schools.',
    keyFeatures: [
      'Three bedrooms',
      'Driveway parking',
    ...
    description: paragraphs(
      'A three bedroom semi-detached house on a quiet residential street in Ashby. The ground floor has a front lounge, a separate dining room and a fitted kitchen with space for a washing machine and a fridge freezer.',
      'Upstairs there are two double bedrooms, a single bedroom and a family bathroom with a shower over the bath. Outside there is a driveway to the front and an enclosed garden to the rear with a shed.',
      'Available unfurnished. Pets considered on application.',
    ),
  },
  {
    title: 'Two bedroom terraced house, Crosby',
    displayLocation: 'Crosby, Scunthorpe',
    status: 'available',
    monthlyRent: 550,
    deposit: 630,
    bedrooms: 2,
    ...
    featured: true,
    shortDescription:
      'A two bedroom terrace within walking distance of the town centre, recently redecorated throughout.',
    keyFeatures: [
      'Two bedrooms',
    ...
    description: paragraphs(
      'A two bedroom mid-terrace house that has been redecorated throughout. The lounge opens into a dining area, with a fitted kitchen to the rear leading out to a low-maintenance courtyard garden.',
      'There are two bedrooms on the first floor and a bathroom with a shower over the bath. On-street parking is available.',
    ),
  },
  {
    title: 'One bedroom first floor flat, town centre',
    displayLocation: 'Town centre, Scunthorpe',
    status: 'available',
    monthlyRent: 450,
    deposit: 520,
    bedrooms: 1,
    ...
    featured: true,
    shortDescription:
      'A tidy one bedroom flat a few minutes from the shops and the station, part furnished.',
    keyFeatures: [
      'One double bedroom',
      'Part furnished',
    ...
    description: paragraphs(
      'A first floor flat in a small converted building close to the town centre. It has a double bedroom, a lounge with a kitchen area, and a bathroom with a shower.',
      'Part furnished, with white goods included. There is no allocated parking but permit parking is available nearby.',
    ),
  },
  {
    title: 'Four bedroom detached house, Bottesford',
    displayLocation: 'Bottesford, Scunthorpe',
    status: 'available',
    monthlyRent: 1050,
    deposit: 1210,
    bedrooms: 4,
    ...
    gardenIncluded: true,
    shortDescription:
      'A four bedroom detached family home with a garage, en-suite to the main bedroom and a large rear garden.',
    keyFeatures: [
      'Four bedrooms',
    ...
    description: paragraphs(
      'A detached family home in a popular part of Bottesford. Downstairs there is a lounge, a separate dining room, a fitted kitchen with a utility room off it, and a cloakroom.',
      'Upstairs there are four bedrooms, with an en-suite shower room to the main bedroom, plus a family bathroom. Outside there is a driveway, a single garage and a good sized lawned garden to the rear.',
    ),
  },
  {
    title: 'Two bedroom bungalow, Brumby',
    displayLocation: 'Brumby, Scunthorpe',
    status: 'let-agreed',
    monthlyRent: 675,
    bedrooms: 2,
    bathrooms: 1,
    ...
    gardenIncluded: true,
    shortDescription:
      'A two bedroom detached bungalow with a level garden and off-street parking. Let agreed.',
    keyFeatures: ['Two bedrooms', 'Level access', 'Off-street parking', 'Enclosed garden'],
    description: paragraphs(
      'A two bedroom bungalow with a lounge, a fitted kitchen, a wet room and a level garden to the rear. Off-street parking to the front.',
    ),
  },
  {
    title: 'Room in a shared house, Frodingham',
    displayLocation: 'Frodingham, Scunthorpe',
    status: 'available',
    monthlyRent: 350,
    deposit: 400,
    bedrooms: 1,
    ...
    parking: 'on-street',
    shortDescription:
      'A furnished double room in a shared house, with bills included and a shared kitchen and bathroom.',
    keyFeatures: [
    ...
    description: paragraphs(
      'A furnished double room in a well-run shared house. The room has a bed, wardrobe and desk. The kitchen, bathroom and lounge are shared with the other residents.',
      'Bills are included in the rent.',
    ),
  },
  {
    title: 'Three bedroom terraced house, Old Brumby',
    displayLocation: 'Old Brumby, Scunthorpe',
    status: 'available',
    monthlyRent: 625,
    deposit: 720,
    bedrooms: 3,
    ...
    gardenIncluded: true,
    shortDescription:
      'A three bedroom terrace with a through lounge and a good sized rear yard, close to local shops.',
    keyFeatures: [
      'Three bedrooms',
      'Through lounge',
      'Rear yard',
    ...
    description: paragraphs(
      'A three bedroom terraced house with a through lounge and dining area, a fitted kitchen and a rear yard.',
      'Three bedrooms and a bathroom on the first floor. Local shops and a bus route are within a short walk.',
    ),
  },
  {
    title: 'Two bedroom flat with parking, Ashby',
    displayLocation: 'Ashby, Scunthorpe',
    status: 'available',
    monthlyRent: 595,
    deposit: 680,
    ...
    parking: 'off-street',
    shortDescription:
      'A modern two bedroom ground floor flat with an allocated parking space and a communal garden.',
    keyFeatures: [
      'Two bedrooms',
      'Allocated parking',
      'Ground floor',
    ...
    description: paragraphs(
      'A ground floor flat in a modern block, with two bedrooms, an open plan lounge and kitchen, and a bathroom with a shower over the bath.',
      'One allocated parking space and use of the communal garden.',
    ),
  },
]
