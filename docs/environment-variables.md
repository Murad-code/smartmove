...
| Variable                                            | Purpose                                                                                                                                                                                                                                       |
| --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `APP_IMAGE`                                         | Which published image to run, e.g. `ghcr.io/murad-code/smartmove:1.1.0`. Note there is no `v`: the release workflow strips it, so a git tag of `v1.1.0` publishes `1.1.0`. Pin a version tag in production so a rollback has somewhere to go. |
